...
export const themeRegistry: StudyTheme[] = [
  ...
  },
  {
    ...
    material: 'glass',
    defaultCandidate: false,
    visualComfort: '深空黑底 + 蓝紫霓虹 + 琥珀暖金点缀，Cosmic Brutalism 设计哲学',
    recommendedFor: ['夜间沉浸', '深度专注', '创意工作', '极客审美'],
    accessibilityNotes: ['深色背景降低眩光', '蓝紫霓虹仅做装饰', '正文使用柔和浅灰', '琥珀暖金用于关键提示'],
    wallpaperSupport: { overlay: 'rgba(2, 6, 23, 0.88)', blur: '24px', brightness: '0.42', saturation: '0.72' },
    design: {
      tone: '深空星海、Cosmic Brutalism、蓝紫霓虹 + 琥珀暖金',
      scene: '借鉴 Radium (Cosmin Capitanu) 设计风格，适合夜间沉浸、深度专注和创意工作',
      principle: '以深空黑为底，蓝紫霓虹作为主色调，琥珀暖金作为点缀色形成冷暖对比，粗野几何装饰线和星点层营造宇宙感。',
      aiVoice: '深空导航型，简短克制，把任务说得像一段星际航行日志。'
    },
    tokens: {
      colors: {
        background: 'linear-gradient(135deg, #020617 0%, #0a0e26 50%, #020617 100%)',
        surface: 'rgba(10, 14, 38, 0.85)',
        surfaceStrong: 'rgba(15, 20, 50, 0.92)',
        primary: '#6366f1',
        secondary: '#a855f7',
        accent: '#f59e0b',
        text: '#e2e8ff',
      ...
      gradients: {
        hero: 'linear-gradient(135deg, #6366f1 0%, #a855f7 50%, #f59e0b 100%)',
        card: 'linear-gradient(135deg, rgba(15, 20, 50, 0.95), rgba(8, 10, 28, 0.9))'
      },
      charts: { plan: '#6366f1', focus: '#a855f7', review: '#f59e0b' },
      effects: { radius: '20px', shadow: '0 24px 80px rgba(0, 0, 0, 0.60)', glass: 'blur(24px) saturate(1.1)' }
    }
  },
  {
