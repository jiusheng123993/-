...
function resolveJwtSecret(): string {
  ...
  if (!secret) {
    ...
    console.warn('[jwtService] WARNING: Using insecure default JWT secret. Set JWT_SECRET environment variable for production.')
    return 'xinghuanhai-dev-secret-key-2026'
  }
  if (secret.length < 32) {
