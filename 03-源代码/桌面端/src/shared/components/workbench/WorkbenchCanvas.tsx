...
export function WorkbenchCanvas({
  ...
  const cardChildren: Record<string, React.ReactNode> = {
    ...
    'habit-tracker': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">习惯追踪模块已移除</div>
      </div>
    ),
    'journal': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">日记模块已移除</div>
      </div>
    ),
    'reading-list': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">阅读列表模块已移除</div>
      </div>
    ),
    'error-book': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">错题本模块已移除</div>
      </div>
    ),
    'memory-cards': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">记忆卡片模块已移除</div>
      </div>
    ),
    'exam-tracker': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">考试追踪模块已移除</div>
      </div>
    ),
    'study-planner': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">学习规划模块已移除</div>
      </div>
    ),
    'focus-timer': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">专注计时器模块已移除</div>
      </div>
    ),
    'study-companion': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">学习伴侣模块已移除</div>
      </div>
    ),
    'mood-journal': (
      <div className="canvas-thumb">
        <div className="canvas-thumb-empty">情绪日记模块已移除</div>
      </div>
    )
  }
