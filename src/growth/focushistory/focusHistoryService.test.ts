...
describe('focusHistoryService', () => {
  ...
  describe('getStreakData', () => {
    ...
    it('sorts by date ascending', () => {
      ...
      expect(data[0].date).toBe(d1.toISOString().split('T')[0])
      expect(data[1].date).toBe(d2.toISOString().split('T')[0])
    })
  })
  ...
  describe('getEfficiencyTrend', () => {
    ...
    it('sorts by date ascending', () => {
      ...
      expect(trend[0].date).toBe(d1.toISOString().split('T')[0])
      expect(trend[1].date).toBe(d2.toISOString().split('T')[0])
    })
  })
})
