...
export interface UseCanvasModulesParams {
  ...
  setIsAIRecommendationOpen: (open: boolean) => void
  setLayoutImportError: (error: string | null) => void
  setIsLayoutShareOpen: (open: boolean) => void
}
...
export function useCanvasModules({
  ...
  }, [setModuleStoreState, setIsAIRecommendationOpen])
  ...
  }, [setModuleStoreState, setLayoutImportError, setIsLayoutShareOpen])
